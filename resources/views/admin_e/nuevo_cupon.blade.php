...
<head>
    ...
    <title>Registrar Nueva Oferta</title>
    <!--css-->
                ...
                <form action="index.php?c=cliente&a=nuevo" method="post"> 
                    ...
                    <div class="container_c">                                       
                        ...
                        <div class="column_3">
                            ...
                            <div class="wrap-input100">                                
                                <select class="input100 s_ele"  >
                                    <option class="input100" value="" disabled>Empresa ofertante</option>
                                    <span class="focus-efecto"></span>
                                    <option class="input100" value="1">Empresa 1</option>
                                    <span class="focus-efecto"></span>
                                    <option class="input100" value="2">Empresa 2</option>
                                    <span class="focus-efecto"></span>
                                    <option class="input100" value="3">Empresa 3</option>
                                    <span class="focus-efecto"></span>
